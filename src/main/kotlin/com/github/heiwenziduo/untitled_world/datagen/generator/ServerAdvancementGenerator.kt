package com.github.heiwenziduo.untitled_world.datagen.generator
...
class ServerAdvancementGenerator : AdvancementProvider.AdvancementGenerator {
    ...
    fun pageMagic(
         ...
         * */
        fun langKey(path: String) = UntitledWorld.modTranslation("advancements.$pageName", path)
        fun saveTo(path: String) = UntitledWorld.modResource("$pageName/$path") // "/" represents folder, not "."
...
//            .parent(AdvancementSubProvider.createPlaceholder("${UntitledWorld.MOD_ID}:$tmpName/root")) // create a new page if empty
            .display(
                ...
                UntitledWorld.modResource("textures/gui/advancements/lore.png"),
